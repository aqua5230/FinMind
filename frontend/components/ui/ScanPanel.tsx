        ...
        <div className="flex flex-col gap-2">
          ...
          {results.map((result) => (
            <button
              ...
              className="flex min-h-9 items-center gap-2 rounded-md bg-[#2C2C2E] px-3 py-2 text-left text-base text-white transition hover:bg-[#3A3A3C] focus:outline focus:outline-1 focus:outline-[#0A84FF]"
            >
              <span className="rounded-md bg-black px-2 py-0.5 text-sm font-semibold text-white">
                {result.stock_id}
              </span>
